...
def test_pytest_exception_interact_with_missing_greenlet():
    ...
    assert "Test error" in error_msg or "MissingGreenlet Error Detected" in error_msg or "Diagnostic Information" in error_msg or "Troubleshooting Steps" in error_msg
...
def test_pytest_exception_interact_when_missing_greenlet_is_none():
    ...
    # Save original
    original_missing_greenlet = MissingGreenlet
